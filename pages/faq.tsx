...
const FaqPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 font-mono">
      <div>
        <h2 className="text-center mt-8 text-7xl">FAQs</h2>
        <div className="flex flex-col items-center mt-8">
          {FAQ_DATA.map((faq, index) => (
            <div
  className={`w-full mx-60 mb-4 rounded-lg overflow-hidden ${
    openIndex === index ?"w-full" : ""
  }`}
>
  <div
  ...
  <div className={`p-4 ${openIndex === index ? "block" : "hidden"} bg-purple-100`}>
